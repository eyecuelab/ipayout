...
module Ipayout
  ...
  class Service
    ...
    # @return [Ipayout::Service]
    # @instantiate Ipayout::Service.new("eWallet_GetCustomerDetails")
    ...
    def initialize(name)
      ...
      # and the value is the actual Ipayout::ServiceParam object
      # parameters['eWallet_GetCustomerDetails'] =
      #             <Object Ipayout::ServiceParam>
      @parameters = {}
